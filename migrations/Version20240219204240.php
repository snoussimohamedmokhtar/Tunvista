 ...
 */
final class Version20240219204240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD region_id INT DEFAULT NULL, DROP region');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` ADD region VARCHAR(255) NOT NULL, DROP region_id');
    }
}
